 ...
 * With the use of the various onChange...() functions, client activities can observe
 * changes in ANY arbitrary expression, and execute UI updates in a .then block.
 *
 * NOTE: all onChange...() listeners are De-registered when Activity is destroyed.
 *
 * Created by powellsc on 25/1/19.
 */
abstract class AutoActivity() : AppCompatActivity() {
